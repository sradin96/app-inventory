...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
	const [cookies, removeCookie] = useCookies(['role', 'token', 'user', 'userId']);
  ...
  const values = useMemo(() => {
    return { currentUser, userId, isAuth, setIsAuth, user, token, role, userExist, setUser, setUserExist, handleLogout, userIsAdmin };
